...
public class LevelManager : MonoBehaviour
{
	...
	public NameYG[] targetDescriptions;
	//UI object
	...
	public GameState gameStatus
	{
		...
		set
		{
			...
			{
				if (YandexGame.savesData.openLevelTest <= 0)
				{
					MusicBase.Instance.GetComponent<AudioSource>().Stop();
					MusicBase.Instance.GetComponent<AudioSource>().loop = true;
				...
				else
				{
					...
					YandexGame.savesData.openLevelTest = 0;
	...
	{
		currentLevel = YandexGame.savesData.openLevel;// TargetHolder.level;
		if (currentLevel == 0)
			currentLevel = 1;
...
return;
	...
	IEnumerator PreWinAnimationsCor()
	{
		...
		if (YandexGame.savesData.LevelStars.GetValueOrDefault($"Level.{currentLevel:000}.StarsCount", 0) < stars)
			YandexGame.savesData.LevelStars[$"Level.{currentLevel:000}.StarsCount"]= stars;
		if (Score > YandexGame.savesData.LevelScore.GetValueOrDefault("Score" + currentLevel))
		{
			YandexGame.savesData.LevelScore["Score" + currentLevel]= Score;
		}
